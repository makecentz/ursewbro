  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-art" aria-hidden="true"><div className="denim-card"><Image src="/brand/custom-jeans-packages.png" alt="" fill sizes="(max-width: 800px) 80vw, 38vw" priority /></div><span className="edition">EST. 2026 / MADE BY HAND</span></div>
