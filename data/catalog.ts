...
export const faqs = [
  ...
  ["Will sold-out pieces return?", "Limited runs may not return, and one-of-one pieces never restock. Join drop alerts for upcoming releases."],
  ...
  ["What is your return policy?", "Eligible unworn pieces can be returned according to the store return window. One-of-one and final-sale items are marked before checkout."],
